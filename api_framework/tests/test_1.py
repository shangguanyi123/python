...
def test_03():
    ...
    Xitongguanli().add_danwei(1, 'm', 1, 'length', 0, '0.001')
...
def test_04():
    ...
    Xitongguanli().add_danjushenhe(['出库单'], '需要审核')
    Xitongguanli().sel_danjushenhe()
    Xitongguanli().update_danjushenhe(['出库单', '入库单'], '无需审核')
    Xitongguanli().update_danjushenhe(['出库单', '入库单'], '超过金额审核', 10000)
