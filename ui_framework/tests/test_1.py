...
class TestUi():
    ...
    def test_2(self, driver):
        ...
        assert click_instance.check_element_presence(By.XPATH,'/html/body/div[4]/section/div[3]/div[2]/div[2]/table')  # 厂家参考价-产品名称模块
        driver.close()
        driver.switch_to.window(driver.window_handles[0])  # 切换到搜索结果页
        ...
        click_instance.click(By.CSS_SELECTOR, 'div:nth-child(5) > div.content-item-right > div.content-item-value > a')  # 安全说明
        driver.switch_to.window(driver.window_handles[1])
        assert driver.current_url == f'{url}RiskAndSafety#Safety'
        driver.close()
        driver.switch_to.window(driver.window_handles[0])
        click_instance.click(By.CSS_SELECTOR, 'div:nth-child(8) > div.content-item-right > div.content-item-value > a')  # 危险品标识
        driver.switch_to.window(driver.window_handles[1])
        assert driver.current_url == f'{url}RiskAndSafety#hazards'
        driver.close()
        driver.switch_to.window(driver.window_handles[0])
        click_instance.click(By.CSS_SELECTOR, 'div.barContent.prdPropInfo-content > div:nth-child(9) > div.content-item-right > div.content-item-value > a')  # 危险类别码
        driver.switch_to.window(driver.window_handles[1])
    ...
    def test_2_A(self,driver):
        ...
        assert cas == '100-51-6'
        wangzhi = driver.find_element(By.XPATH, '/html/body/div[2]/section/div/div[2]/div[2]/div[3]/div[9]/div[2]/div[2]/div[1]/div[2]').text
        click_instance.click(By.XPATH, '/html/body/div[2]/section/div/div[2]/div[2]/div[3]/div[9]/div[2]/div[2]/div[1]/div[2]/a')  # 公司网址
        driver.switch_to.window(driver.window_handles[1])
        ...
        cas1 = driver.find_element(By.XPATH, '/html/body/div[2]/section/div/div[1]/div[1]/div[4]/div[1]/div[1]/span[2]').text
        assert cas1 == '5310-10-1'
        driver.back()
        click_instance.click(By.XPATH, '//*[@id="search-prd-box"]/div[2]/div[1]/div/div[2]/div[2]/a[1]')  # 点击化学性质
        driver.switch_to.window(driver.window_handles[1])
        cas2 = driver.find_element(By.XPATH, '/html/body/div[2]/section/div/div[1]/div[1]/div[4]/div[1]/div[1]/span[2]').text
        assert cas1 == cas2
    ...
    def test_3(self, driver):
        ...
        assert driver.current_url == f'{url}suppliers/100510-65-4'
        cas = driver.find_element(By.CSS_SELECTOR,'div.wrap-prd-basic.mt20.first-type > div > div:nth-child(4) > div.value').text
        assert cas == '100510-65-4'
        driver.back()
        tupu_hgbm = driver.find_element(By.XPATH, '/html/body/div[4]/section/div[1]/div[1]/div[4]/div[1]/div/span[2]/a').text#图谱结果页海关编码
        click_instance.click(By.XPATH,'/html/body/div[4]/section/div[1]/div[1]/div[4]/div[1]/div/span[2]/a')#海关编码，进入海关编码页面
        ...
        assert click_instance.check_element_presence(By.XPATH,'/html/body/div[4]/section/div[3]/div[2]/div[2]/table/tbody/tr[1]/td[4]') == True #存在试剂价格
        assert click_instance.check_element_presence(By.XPATH,'/html/body/div[4]/section/div[4]/div[2]/div[2]/table/tbody/tr[1]/td[4]') == True  # 存在厂家价格
        cas = driver.find_element(By.XPATH,
        ...
        assert newgys[0] in gongyingsahng
        driver.back()
    ...
    def test_4(self, driver):
        ...
        assert click_instance.check_element_presence(By.XPATH,'/html/body/div[2]/section/div/div[2]') == True  # 存在海关种类模块
        driver.back()
        click_instance.click(By.XPATH, '/html/body/div[2]/section/div/div[3]/a[2]/img')  # 海关监管条件码
        assert click_instance.check_element_presence(By.CLASS_NAME,'supervision-condition-code-table') == True  # 海关监管条件代码模块
        driver.back()
    ...
    def test_5(self,driver):
        ...
        if gys_shuliang_new[0] != 0:
            ...
            assert False
        gys_chanpin = driver.find_element(By.XPATH,'/html/body/div[2]/section/div/div[2]/div[1]/div[1]').text  # 供应商页面，产品名称
    ...
    def test_6(self, driver):
        ...
        click_instance.click(By.XPATH,
                             '//*[@id="search-prd-box"]/div[2]/div[1]/div[1]/div[2]/div[2]/a[2]')  # 点击化学性质
        driver.switch_to.window(driver.window_handles[1])
        cas = driver.find_element(By.XPATH,'/html/body/div[2]/section/div/div[1]/div[1]/div[4]/div[1]/div[1]/span[2]').text
        click_instance.click(By.XPATH, '/html/body/div[2]/section/div/div[2]/div[1]/div')  # 编辑结构式
    ...
    def test_7(self, driver):
        ...
        assert click_instance.check_element_presence(By.XPATH, '/html/body/div[2]/section/div/div[2]') == True  # 提问模块
        assert click_instance.check_element_presence(By.XPATH,'/html/body/div[2]/section/div/div[2]/form/button') == True  # 立即提交
        driver.back()
